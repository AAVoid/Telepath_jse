...
public class DialogEspritTelepath extends JDialog {
	...
	private static final String TEXTE = 
			"<html>"
					...
					+ "<br><br>Attention donc à avoir lu tous les messages avant de vous en aller !<br>"
					+ "<br><br><font size=\"6\">Bonne discussion ! :)</font>"
					+ "<br><br>"
					+ "<font size=\"4\">" + Fenetre.getNomAuteur() + "</font>"
					+ "<br><br><br>- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - <br><br><br>"
					+ "<h1>A venir dans une prochaine version</h1><br>"
					+ "<br><font size=\"5\">Export de conversation : </font><br>Vous pourrez exporter une conversation dans un fichier"
					...
					+ "<br>l'envoie ou la reception.<br><br><br>"
					+ "</html>";
